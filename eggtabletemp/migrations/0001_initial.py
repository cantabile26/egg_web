# Generated by Django 4.1.4 on 2022-12-16 03:34
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("farm_code", models.IntegerField(max_length=50, verbose_name="농장 번호")),
                (
                    "barn_code",
                    models.CharField(
                        max_length=10, unique=True, verbose_name="사업자 등록번호"
                    ),
                ),
                (
                    "회계코드",
                    models.CharField(max_length=10, unique=True, verbose_name="회계코드"),
                ),
                (
                    "계좌번호",
                    models.IntegerField(
                        max_length=100, unique=True, verbose_name="계죄번호"
                    ),
                ),
                ...
                ("수입", models.IntegerField(max_length=256, verbose_name="수입")),
                ("지출", models.IntegerField(max_length=256, verbose_name="지출")),
